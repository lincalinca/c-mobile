...
const STAVE_CONFIGS = [
  // Group 1
  { baseYPercent: 0.12, phase: 0, amplitude: 9, frequency: 0.6 },
  { baseYPercent: 0.16, phase: Math.PI / 4, amplitude: 7, frequency: 0.8 },
  { baseYPercent: 0.20, phase: Math.PI / 2, amplitude: 9, frequency: 0.7 },
  { baseYPercent: 0.24, phase: (3 * Math.PI) / 4, amplitude: 7, frequency: 0.75 },
  { baseYPercent: 0.28, phase: Math.PI, amplitude: 9, frequency: 0.65 },
  // Group 2
  { baseYPercent: 0.42, phase: Math.PI / 3, amplitude: 9, frequency: 0.62 },
  { baseYPercent: 0.46, phase: Math.PI / 2, amplitude: 7, frequency: 0.78 },
  { baseYPercent: 0.50, phase: (2 * Math.PI) / 3, amplitude: 9, frequency: 0.68 },
  { baseYPercent: 0.54, phase: (5 * Math.PI) / 6, amplitude: 7, frequency: 0.72 },
  { baseYPercent: 0.58, phase: Math.PI, amplitude: 9, frequency: 0.64 },
  // Group 3
  { baseYPercent: 0.72, phase: Math.PI / 6, amplitude: 9, frequency: 0.61 },
  { baseYPercent: 0.76, phase: Math.PI / 3, amplitude: 7, frequency: 0.76 },
  { baseYPercent: 0.80, phase: Math.PI / 2, amplitude: 9, frequency: 0.66 },
  { baseYPercent: 0.84, phase: (2 * Math.PI) / 3, amplitude: 7, frequency: 0.74 },
  { baseYPercent: 0.88, phase: (5 * Math.PI) / 6, amplitude: 9, frequency: 0.63 },
] as const;
